...
public class LocationResourceIntTest {
    ...
    private static final Integer DEFAULT_NUMBER_ADDRESS = 1;
    private static final Integer UPDATED_NUMBER_ADDRESS = 2;
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getNeighborhood()).isEqualTo(DEFAULT_NEIGHBORHOOD);
    ...
    @Test
    @Transactional
    public void checkNumberAddressIsRequired() throws Exception {
        int databaseSizeBeforeTest = locationRepository.findAll().size();
        // set the field null
        location.setNumberAddress(null);
    ...
    public void getAllLocations() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].numberAddress").value(hasItem(DEFAULT_NUMBER_ADDRESS)))
    ...
    public void getLocation() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations/{id}", location.getId()))
            ...
            .andExpect(jsonPath("$.numberAddress").value(DEFAULT_NUMBER_ADDRESS))
    ...
    public void updateLocation() throws Exception {
        ...
        assertThat(testLocation.getNeighborhood()).isEqualTo(UPDATED_NEIGHBORHOOD);
