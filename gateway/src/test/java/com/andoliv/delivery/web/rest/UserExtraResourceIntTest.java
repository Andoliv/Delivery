...
public class UserExtraResourceIntTest {
    ...
    public void createUserExtra() throws Exception {
        ...
        assertThat(testUserExtra.getComments()).isEqualTo(DEFAULT_COMMENTS);
    }
    ...
    public void updateUserExtra() throws Exception {
        ...
        assertThat(testUserExtra.getComments()).isEqualTo(UPDATED_COMMENTS);
    }
